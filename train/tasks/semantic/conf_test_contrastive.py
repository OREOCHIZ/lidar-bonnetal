...
from tasks.semantic.modules.confusion_matrix_contrastive import *


if __name__ == '__main__':
  parser = argparse.ArgumentParser("./conf_test_contrastive.py")
  parser.add_argument(
      '--dataset', '-d',
      type=str,
      required=True,
  ...
  try:
    ...
    ARCH = yaml.safe_load(open(FLAGS.arch_cfg ,'r')) # edit
